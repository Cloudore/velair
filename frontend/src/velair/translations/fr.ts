export const fr = {
 "addBlock": "Ajouter un bloc",
  ...
  "externalExecutionVelair": "Velair (local execution)", "externalExecutionLocal": "Executed by Velair", "externalExecutionEnabled": "External schedule execution enabled", "externalExecutionDisabled": "Velair schedule execution enabled", "externalScheduleRequired": "Créez et enregistrez un programme comportant au moins un bloc de température avant d’activer l’exécution externe.", "externalSwitchpointUsage": "{used} sur {max} points de commutation du contrôleur", "externalSwitchpointBreakdown": "{count} blocs programmés", "externalSwitchpointBreakdownContinuity": "{count} blocs programmés + 1 point de continuité à minuit", "externalActionsInactive": "Velair actions are inactive because this climate is executed by an external system.",
  "overviewZoneExternal": "External execution", "overviewExternalLabel": "Externe", "overviewExternalExecutionDescription": "The planned timeline is executed by the external controller. Velair does not send climate actions to this zone.", "overviewExternalZonesUnaffected": "{count} externally executed zone(s) are unaffected by Velair actions.", "manualUnavailableExternalExecution": "Manual control is unavailable for externally executed climates.",
