export const nl = {
 "addBlock": "Blok toevoegen",
  "externalConditionProfilesSupported": "Default, Profile and Mode schedules are supported", "profileExternalScheduleOnly": "External zones support Default, Profile or Mode schedules only. Pause and direct Velair actions remain unavailable.", "profileExternalMaxChanges": "{climate} exceeds the controller limit of {count} changes on {day}.", "profileExternalTimeGrid": "{climate} must use {minutes}-minute intervals on {day}.", "profileExternalUnsupportedBlock": "{climate} contains a block that the external controller cannot represent.",
  "externalControllersInUse": "External controllers in use", "externalConditionDefaultOnly": "Default schedules only", "externalConditionHvacModes": "Supported HVAC modes: {modes}", "externalConditionTargetTypes": "Supported target types: {types}", "externalConditionActions": "Supported schedule actions: {actions}", "externalConditionTurnOffUnsupported": "Turn-off blocks are not supported", "externalConditionOptionFields": "Supported climate options: {fields}", "externalConditionOptionsUnsupported": "Climate option fields are not supported", "externalConditionMaxChanges": "Maximum {count} schedule changes per day", "externalConditionTimeGrid": "Times must use {minutes}-minute intervals", "externalConditionMidnightContinuityCounts": "An implicit midnight continuity change counts toward the daily maximum", "externalConditionsUnavailable": "Controller conditions are unavailable.",
  "externalCapability_action_set_temperature": "Set temperature", "externalCapability_action_turn_off": "Turn off", "externalCapability_hvac_heat": "Heating", "externalCapability_hvac_cool": "Cooling", "externalCapability_target_scalar": "Single target temperature", "externalCapability_target_range": "Target temperature range",
  "externalProviderAvailability": "Controller: {state}", "externalProviderAvailable": "available", "externalProviderUnavailable": "unavailable", "externalPublication_publishing": "Publishing the effective schedule to the external integration.", "externalPublication_published": "The external integration accepted the effective schedule.", "externalPublication_failed": "Schedule publication failed.", "overviewExternalExecutionProvider": "External controller: {provider}", "overviewExternalInfoAction": "Over externe uitvoering via {provider}", "overviewExternalStatusPublishing": "Bezig met publiceren", "overviewExternalStatusAccepted": "Geaccepteerd", "overviewExternalStatusFailed": "Mislukt", "overviewExternalStatusUnavailable": "Niet beschikbaar", "overviewExternalProviderUnavailable": "The external integration is currently unavailable. Velair remains inactive for this climate.",
  "externalSystems": "External systems", "externalSystemsDescription": "Choose who executes the effective weekly schedule for compatible climates. External zones are never physically controlled by Velair.",
  "externalExecutionVelair": "Velair (local execution)", "externalExecutionLocal": "Executed by Velair", "externalExecutionEnabled": "External schedule execution enabled", "externalExecutionDisabled": "Velair schedule execution enabled", "externalScheduleRequired": "Maak en bewaar een schema met minstens één temperatuurblok voordat je externe uitvoering inschakelt.", "externalSwitchpointUsage": "{used} van {max} schakelmomenten van de controller", "externalSwitchpointBreakdown": "{count} geplande blokken", "externalSwitchpointBreakdownContinuity": "{count} geplande blokken + 1 continuïteitspunt om middernacht", "externalActionsInactive": "Velair actions are inactive because this climate is executed by an external system.",
  "overviewZoneExternal": "External execution", "overviewExternalLabel": "Extern", "overviewExternalExecutionDescription": "The planned timeline is executed by the external controller. Velair does not send climate actions to this zone.", "overviewExternalZonesUnaffected": "{count} externally executed zone(s) are unaffected by Velair actions.", "manualUnavailableExternalExecution": "Manual control is unavailable for externally executed climates.",
