export const ru = {
  ...
  "externalExecutionVelair": "Velair (локальное выполнение)", "externalExecutionLocal": "Выполняется Velair", "externalExecutionEnabled": "Внешнее выполнение расписания включено", "externalExecutionDisabled": "Выполнение расписания Velair включено", "externalActionsInactive": "Действия Velair неактивны, поскольку этим климатическим устройством управляет внешняя система.",
  "overviewZoneExternal": "Внешнее выполнение", "overviewExternalExecutionDescription": "Плановое расписание выполняет внешний контроллер. Velair не отправляет климатические команды в эту зону.", "overviewExternalZonesUnaffected": "Действия Velair не влияют на внешние зоны: {count}.", "manualUnavailableExternalExecution": "Ручное управление недоступно для зон с внешним выполнением.",
